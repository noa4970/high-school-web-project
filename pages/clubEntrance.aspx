<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="clubEntrance.aspx.cs" Inherits="finalProject.pages.WebForm1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>פאות שבי פלס/כניסת מועדון</title>
...
<body onload="startTime()">
    ...
    <div class="box1">
        ...
        <div class='box'>
            <form class="clabForm">
                <h2 class="clabH">כניסת מועדון</h2>
                <fieldset>
                    <legend>אנא בחרי</legend>
                </fieldset>
                <div class="clabE">
                    <input type="radio" class="inputRadio" name="club" id="exist" value="exist" />
                    <label class="info" for="exist">יש לי כבר מועדון</label>
                </div>
                <div class="clabE">
                    <input type="radio" class="inputRadio" name="club" id="new" value="new" />
                    <label class="info" for="new">אני רוצה להצטרף למועדון</label>
                </div>
